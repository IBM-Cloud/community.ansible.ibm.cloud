...
#    iam_token = Authenticator.get_iam_token()
    ...
    module.params["iam_token"] = Authenticator.get_iam_token(ibmcloud_api_key)
    ...
    module.exit_json(Change=True, msg=cluster_info)
